    ...
    pub mod component {
        ...
        pub mod nfs_rs {
            ...
            pub mod nfs {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_nfs_mount_open_cabi<T: GuestNfsMount>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: *mut u8,
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_nfs_mount_open<T: GuestNfsMount>(
                    arg0: *mut u8,
                ) {
                    let l0 = i32::from(*arg0.add(0).cast::<u8>());
                    match l0 {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_nfs_mount_open_path_cabi<
                    T: GuestNfsMount,
                >(arg0: *mut u8, arg1: *mut u8, arg2: usize, arg3: i32) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let len0 = arg2;
                    let bytes0 = _rt::Vec::from_raw_parts(arg1.cast(), len0, len0);
                    let result1 = T::open_path(
                        NfsMountBorrow::lift(arg0 as u32 as usize).get(),
                        _rt::string_lift(bytes0),
                        arg3 as u32,
                    );
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_nfs_mount_open_path<
                    T: GuestNfsMount,
                >(arg0: *mut u8) {
                    let l0 = i32::from(*arg0.add(0).cast::<u8>());
                    match l0 {
                ...
                pub trait GuestNfsMount: 'static {
                    ...
                    /// OPEN procedure — open a file for read/write access
                    fn open(&self, dir_fh: Fh, filename: _rt::String, access: u32) -> Result<ObjRes, Error>;
                    /// OPEN procedure for a path
                    fn open_path(&self, path: _rt::String, access: u32) -> Result<ObjRes, Error>;
                    /// CLOSE procedure — release share reservations for a file
                    fn close(&self, fh: Fh) -> Result<(), Error>;
                    /// COMMIT procedure
                    ///
                ...
                macro_rules! __export_component_nfs_rs_nfs_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        * mut u8,) { $($path_to_types)*::
                        ...
                        $($path_to_types)*:: Guest >::NfsMount > (arg0) } #[export_name =
                        "component:nfs-rs/nfs#[method]nfs-mount.open"] unsafe extern "C"
                        fn export_method_nfs_mount_open(arg0 : * mut u8, arg1 : *
                        mut u8, arg2 : usize, arg3 : * mut u8, arg4 : usize, arg5 : i32,) -> * mut u8 {
                        $($path_to_types)*::
                        _export_method_nfs_mount_open_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::NfsMount > (arg0, arg1, arg2, arg3, arg4, arg5) }
                        #[export_name =
                        "cabi_post_component:nfs-rs/nfs#[method]nfs-mount.open"] unsafe
                        extern "C" fn _post_return_method_nfs_mount_open(arg0 : * mut
                        u8,) { $($path_to_types)*::
                        __post_return_method_nfs_mount_open::<<$ty as
                        $($path_to_types)*:: Guest >::NfsMount > (arg0) } #[export_name =
                        "component:nfs-rs/nfs#[method]nfs-mount.open-path"] unsafe extern
                        "C" fn export_method_nfs_mount_open_path(arg0 : * mut u8, arg1 : *
                        mut u8, arg2 : usize, arg3 : i32,) -> * mut u8 {
                        $($path_to_types)*::
                        _export_method_nfs_mount_open_path_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::NfsMount > (arg0, arg1, arg2, arg3) }
                        #[export_name =
                        "cabi_post_component:nfs-rs/nfs#[method]nfs-mount.open-path"] unsafe
                        extern "C" fn _post_return_method_nfs_mount_open_path(arg0 : * mut
                        u8,) { $($path_to_types)*::
                        __post_return_method_nfs_mount_open_path::<<$ty as
                        $($path_to_types)*:: Guest >::NfsMount > (arg0) } #[export_name =
                        "component:nfs-rs/nfs#[method]nfs-mount.close"] unsafe extern "C"
                        fn export_method_nfs_mount_close(arg0 : * mut u8, arg1 : *
